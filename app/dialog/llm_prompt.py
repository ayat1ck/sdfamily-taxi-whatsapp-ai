...
def build_faq_assist_system_prompt() -> str:
    return (
        ...
        "Если в базе знаний нет ответа, не придумывай — предложи приехать в офис SD Family Taxi и укажи адрес из базы знаний (park_info). "
...
def build_system_prompt() -> str:
    return (
        ...
        "Если спрашивают про аренду авто или машину от таксопарка, отвечай: аренды машин пока нет, сейчас подключаем только водителей со своими автомобилями. "
