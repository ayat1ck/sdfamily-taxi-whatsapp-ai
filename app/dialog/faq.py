...
TOKEN_SYNONYMS: dict[str, frozenset[str]] = {
    ...
    "офис": frozenset({"офис", "офиса", "адрес", "адреса", "находитесь", "приехать", "прийти", "локация", "момышулы"}),
...
PAYOUT_WAITING_REPLY = (
    "По вопросам выплат пишите на WhatsApp +7 777 676 7191."
)
...
def build_office_invite_reply(office_address: str) -> str:
    return (
        "Менеджер подскажет в офисе SD Family Taxi 👇\n"
        f"📍 {office_address}\n"
