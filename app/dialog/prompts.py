...
PROMPTS: dict[DialogueState, str] = {
    ...
    DialogueState.ASK_YANDEX_PRO_PROBLEM_DETAILS: "Если у вас ошибка во входе в Яндекс Про, напишите, что именно не получается, или пришлите скриншот.",
    DialogueState.YANDEX_ERROR: "Не удалось автоматически отправить заявку. Данные сохранены, попробуем обработать повторно.",
    DialogueState.COMPLETED: "Спасибо. Если вход в Яндекс Про уже завершен, значит регистрация закончена. Если понадобится помощь, напишите в этот чат.",
}
...
STATUS_REPLIES = {
    ...
    "completed": "Регистрация завершена. Если понадобится помощь по Яндекс Про или работе, напишите в этот чат.",
    "awaiting_manager_review": "Ваше сообщение передано менеджеру. Если есть скриншот ошибки, отправьте его сюда. После успешного входа напишите: Вошел.",
...
YANDEX_PRO_INSTALL_TEMPLATE = (
    ...
    "Если появится ошибка, напишите: Ошибка, или пришлите скриншот."
)
