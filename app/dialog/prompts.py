...
MANUAL_ENTRY_HINT = (
    "✍️ Или напишите «вручную», «заполню сам», «без фото» — введем данные текстом, как в документе."
)
...
MANUAL_ENTRY_HINT = (
    "✍️ Или напишите «вручную», «заполню сам», «без фото» — введём данные текстом, как в документе."
)
CAR_MODEL_PROMPT = (
    "🚘 Напишите модель автомобиля, как в документах или техпаспорте "
    "(Camry, Rio, S-Class, X5 и т.п.). "
